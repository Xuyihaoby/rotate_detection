...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/vic_reg_resnet50.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/vic_reg'
# # mAP: 0.7031411835473467
# # ap of each class: plane:0.8814038654972652, baseball-diamond:0.7158003346613107, bridge:0.44096120511758014, ground-track-field:0.6592012571087088, small-vehicle:0.7770284861438198, large-vehicle:0.7400908111502202, ship:0.8625346128334026, tennis-court:0.9085379274363731, basketball-court:0.7675178003043186, storage-tank:0.8174066795273891, soccer-ball-field:0.4977310727434215, roundabout:0.6098576687316314, harbor:0.6054443276051604, swimming-pool:0.6715948619532871, helicopter:0.5920068423963105
# # COCO style result:
# #
# # AP50: 0.7031411835473467
# # AP75: 0.38658097820932186
# # mAP: 0.39274127696435285
