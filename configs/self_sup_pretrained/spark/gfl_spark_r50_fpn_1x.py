...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/timm_resnet50_1kpretrained.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/spark/res50'
# 824 stride
# mAP: 0.5991844772381804
# ap of each class: plane:0.8618429665207467, baseball-diamond:0.598067427526004, bridge:0.39895705342124665, ground-track-field:0.4663405007702083, small-vehicle:0.7557249270232332, large-vehicle:0.7156243018578238, ship:0.8142594480225346, tennis-court:0.9078715996278911, basketball-court:0.6015682464673342, storage-tank:0.7687845657105274, soccer-ball-field:0.255635025081876, roundabout:0.4794179869500275, harbor:0.5320326366559374, swimming-pool:0.55645719199658, helicopter:0.2751832809407344
# COCO style result:
#
# AP50: 0.5991844772381804
# AP75: 0.3269916553012543
# mAP: 0.3336291939264596
