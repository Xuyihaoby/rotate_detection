...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/repvgg-B1g2_3rdparty_4xb64-coslr-120e_in1k_20210909-344f6422.pth',
    # noqa
    backbone=dict(
        type='RepVGG',
        arch='B1g2',
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/rgfl/repvgg'

# mAP: 0.7095489511872812
# ap of each class: plane:0.8843176435490507, baseball-diamond:0.7092449917067182, bridge:0.5032176472910376, ground-track-field:0.6702423842063604, small-vehicle:0.7911295270033271, large-vehicle:0.7524200050010275, ship:0.8691038882711013, tennis-court:0.9090229650767769, basketball-court:0.8251922179532164, storage-tank:0.8204492404220985, soccer-ball-field:0.5391857880624262, roundabout:0.617148462573629, harbor:0.6496432194205425, swimming-pool:0.5968677817156992, helicopter:0.5060485055562045
# COCO style result:
#
# AP50: 0.7095489511872812
# AP75: 0.40283117614946595
# mAP: 0.40533047346651063