...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/cswin_tiny_224.pth',
    backbone=dict(
        type='CSWin',
        embed_dim=64,
        depth=[1, 2, 21, 1],
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/cswin/gfl_tiny_new'
# mAP: 0.7483074441928065
# ap of each class: plane:0.8900018461863527, baseball-diamond:0.7488462508327202, bridge:0.5383789403873931, ground-track-field:0.6817886901504733, small-vehicle:0.789860585643762, large-vehicle:0.8297496151582552, ship:0.8775650189318374, tennis-court:0.9090234691124901, basketball-court:0.840041170749957, storage-tank:0.851082258351255, soccer-ball-field:0.5776612611539561, roundabout:0.6466170445540397, harbor:0.7069992352833037, swimming-pool:0.732540455494718, helicopter:0.6044558209015859
# COCO style result:
#
# AP50: 0.7483074441928065
# AP75: 0.467489574508409
# mAP: 0.44771190735064936