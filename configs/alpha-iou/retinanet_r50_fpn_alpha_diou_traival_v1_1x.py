model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='AlphaRotatedDIoULoss', loss_weight=1.0)),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/alpha_diou'
# mAP: 0.692756125209417
# ap of each class: plane:0.8876226630839641, baseball-diamond:0.7404489343340442, bridge:0.4587257057027524, ground-track-field:0.6341121727435591, small-vehicle:0.7900883506768187, large-vehicle:0.6999358580974696, ship:0.8453376626622756, tennis-court:0.9089539978094197, basketball-court:0.8041305341831861, storage-tank:0.8086381216312886, soccer-ball-field:0.4649575918296033, roundabout:0.6637472550686458, harbor:0.6000227108857417, swimming-pool:0.6642238187000155, helicopter:0.42039650073246915
# COCO style result:
#
# AP50: 0.692756125209417
# AP75: 0.40204031497936515
# mAP: 0.39936152878675835