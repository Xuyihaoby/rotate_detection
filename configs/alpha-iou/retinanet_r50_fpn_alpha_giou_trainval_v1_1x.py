model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='AlphaRotatedGIoULoss', loss_weight=1.0)),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/alpha_giou'
# mAP: 0.6947040195701509
# ap of each class: plane:0.8842327818841075, baseball-diamond:0.7653086098611438, bridge:0.46967940412919346, ground-track-field:0.6374695325663056, small-vehicle:0.7902487181178589, large-vehicle:0.7013866857526082, ship:0.8432774735393038, tennis-court:0.9090230664857533, basketball-court:0.8254126874772459, storage-tank:0.8051315357212379, soccer-ball-field:0.4628104245228497, roundabout:0.6535935490737743, harbor:0.6003281035939508, swimming-pool:0.6385509281716416, helicopter:0.43410679265528807
# COCO style result:
#
# AP50: 0.6947040195701509
# AP75: 0.40399927403804886
# mAP: 0.40030425476587556