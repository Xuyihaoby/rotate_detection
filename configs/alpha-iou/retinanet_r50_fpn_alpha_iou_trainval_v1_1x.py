model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='AlphaRotatedIoULoss', loss_weight=1.0)),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/alpha_iou'
# mAP: 0.7016489058702596
# ap of each class: plane:0.8854584414063266, baseball-diamond:0.7529566098015432, bridge:0.4523795258146297, ground-track-field:0.6382073328942303, small-vehicle:0.7916162386662391, large-vehicle:0.7162961926300092, ship:0.8418251200479359, tennis-court:0.9089557282865834, basketball-court:0.8168998504082219, storage-tank:0.7992752191130236, soccer-ball-field:0.4463074595565598, roundabout:0.6711938580861656, harbor:0.5903861510261565, swimming-pool:0.6645860023940211, helicopter:0.5483898579222483
# COCO style result:
#
# AP50: 0.7016489058702596
# AP75: 0.406936140608501
# mAP: 0.403600595904574