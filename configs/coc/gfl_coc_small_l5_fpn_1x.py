...
model = dict(
    ...
    backbone=dict(
        type='context_cluster_small_feat5',
        style='pytorch'
    ),
    neck=dict(
        type='FPN',
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/coc/feat5'
# mAP: 0.7068561723028408
# ap of each class: plane:0.886054422314452, baseball-diamond:0.698748166837275, bridge:0.4321425481383498,
# ground-track-field:0.6684360049380734, small-vehicle:0.7785862211208915, large-vehicle:0.7962650523409127,
# ship:0.8694418243220208, tennis-court:0.9086763581521538, basketball-court:0.7737267356140461,
# storage-tank:0.8106200405948677, soccer-ball-field:0.5045408247634559, roundabout:0.5973121329376162,
# harbor:0.6328416226779122, swimming-pool:0.7136398678730674, helicopter:0.5318107619175153
# COCO style result:
#
# AP50: 0.7068561723028408
# AP75: 0.43124850562295836
# mAP: 0.41805001529061164