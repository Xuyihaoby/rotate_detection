...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/model_best.pth.tar',
    backbone=dict(
        type='context_cluster_small_feat7',
        style='pytorch'
    ),
    neck=dict(
        type='FPN',
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/coc/feat7'

# mAP: 0.6842397325129684
# ap of each class: plane:0.8880206700371861, baseball-diamond:0.6630472267535464, bridge:0.4522302818179578, ground-track-field:0.6346935209942433, small-vehicle:0.7729793143753472, large-vehicle:0.7554744365499518, ship:0.8573692293808204, tennis-court:0.9090230664857533, basketball-court:0.7485442150418498, storage-tank:0.7673935892927868, soccer-ball-field:0.49669974453798377, roundabout:0.6118732732662385, harbor:0.6035595227770656, swimming-pool:0.7083511137424642, helicopter:0.39433678264133026
# COCO style result:
#
# AP50: 0.6842397325129684
# AP75: 0.40509747086470754
# mAP: 0.3954610411146019