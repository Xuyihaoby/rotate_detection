model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='ProbiouLoss', mode='l2', loss_weight=1.0)),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/simDOTA1_0/retinanet_prob_iou_l2'

# mAP: 0.6761289190329385
# ap of each class: plane:0.8870183946105609, baseball-diamond:0.7586315637163611, bridge:0.38457417775109265, ground-track-field:0.6528905438642855, small-vehicle:0.7521314766328165, large-vehicle:0.663708698984561, ship:0.7755245589420517, tennis-court:0.9078863789322474, basketball-court:0.789150644759255, storage-tank:0.7441000154625862, soccer-ball-field:0.5796898323968398, roundabout:0.6034370174004031, harbor:0.5110923064207559, swimming-pool:0.6682250409160702, helicopter:0.4638731347041903
# COCO style result:
#
# AP50: 0.6761289190329385
# AP75: 0.29892158753905057
# mAP: 0.35184520119892493