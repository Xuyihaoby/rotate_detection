...
custom_hooks = [dict(type='ExpMomentumEMAHook', resume_from=resume_from, priority=49),
                dict(type='ModeSwitchHook', num_last_epochs=6, priority=48)]
workflow = [('train', 1)]
work_dir = '/home/lzy/xyh/Netmodel/rotate_detection/checkpoints/DOTA1_0/oriented2bboxmosaicrotateema'
