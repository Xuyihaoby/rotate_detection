...
model = dict(
    type='RGFL',
    pretrained='/home/user/xyh/rotate_detection/checkpoints/vitae-b-checkpoint-1599-transform-no-average.pth',
    backbone=dict(
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/data/Aerial/checkpoints/checkpoints/rgfl/vitaervsa'

# mAP: 0.6041577324565856
# ap of each class: plane:0.8596083258738577, baseball-diamond:0.5130242491789411, bridge:0.38338484576801357, ground-track-field:0.5383350627828999, small-vehicle:0.7188564118847081, large-vehicle:0.7294939666106945, ship:0.781878302193033, tennis-court:0.9071237131104095, basketball-court:0.5614229803697214, storage-tank:0.6223125257304511, soccer-ball-field:0.29055259525832167, roundabout:0.46372932272556394, harbor:0.6026751982980877, swimming-pool:0.7177867402781135, helicopter:0.37218174678596827
# COCO style result:
#
# AP50: 0.6041577324565856
# AP75: 0.3279931591705338
# mAP: 0.33737154324192076
