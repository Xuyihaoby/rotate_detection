...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/rednet50-1c7a7c5d.pth',
    backbone=dict(
        type='RedNet',
        depth=50,
        num_stages=4,
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/rednet/gfl_tiny_new'
# mAP: 0.6419586486128714
# ap of each class: plane:0.8637019339943637, baseball-diamond:0.6102030879499477, bridge:0.42277972375191525, ground-track-field:0.5690082464984142, small-vehicle:0.7408812422035607, large-vehicle:0.7345093039409167, ship:0.7842495074869805, tennis-court:0.9083230784276686, basketball-court:0.6809278116106245, storage-tank:0.741876668544865, soccer-ball-field:0.4280947283175213, roundabout:0.5242788858020758, harbor:0.649590839176177, swimming-pool:0.5897084544582776, helicopter:0.3812462170297642
# COCO style result:
#
# AP50: 0.6419586486128714
# AP75: 0.35213010816521323
# mAP: 0.3613750929700946