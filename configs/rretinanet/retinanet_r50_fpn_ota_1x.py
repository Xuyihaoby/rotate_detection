...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/rretinanet/ota'
# find_unused_parameters = True

# simota
# mAP: 0.6906852836565618
# ap of each class: plane:0.8836212992677409, baseball-diamond:0.6643741899206087, bridge:0.47459877754886476, ground-track-field:0.6140433195467508, small-vehicle:0.7828742411697709, large-vehicle:0.7448479411428776, ship:0.8669163790729377, tennis-court:0.9086167186018157, basketball-court:0.7917965988074496, storage-tank:0.8139352534299392, soccer-ball-field:0.47578376821370316, roundabout:0.6031691624420006, harbor:0.5901313302935149, swimming-pool:0.6661911209004038, helicopter:0.47937915449004814
# COCO style result:
#
# AP50: 0.6906852836565618
# AP75: 0.3800704942789905
# mAP: 0.3855189193592651
