model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='RotatedGIoULoss', loss_weight=1.0)),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data1/xyh/checkpoints/simDOTA1_0/rotate_giou'

# mAP: 0.656631923156575
# ap of each class: plane:0.8892848761747411, baseball-diamond:0.7367430581828605, bridge:0.3883870472810349,
# ground-track-field:0.6273699892656796, small-vehicle:0.7655606857128889, large-vehicle:0.6230462360287488,
# ship:0.7714584654549569, tennis-court:0.908616010854817, basketball-court:0.7877674575145711,
# storage-tank:0.745105578106207, soccer-ball-field:0.5240728294379233, roundabout:0.5932559338792315,
# harbor:0.5214087880034112, swimming-pool:0.5997642773861741, helicopter:0.3676376140653793
