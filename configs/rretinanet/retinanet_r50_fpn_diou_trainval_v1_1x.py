model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='RotatedDIoULoss', loss_weight=1.0)),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/diou/linear'

# mAP: 0.7041049544393588
# ap of each class: plane:0.8865185553351641, baseball-diamond:0.7310603353940296, bridge:0.4626605640550585, ground-track-field:0.6731770582528569, small-vehicle:0.7914311110305188, large-vehicle:0.7064499496875805, ship:0.8446398625188815, tennis-court:0.908817322643414, basketball-court:0.8337690990893599, storage-tank:0.8081135757953574, soccer-ball-field:0.4753067153084779, roundabout:0.6498512708832218, harbor:0.6033607909871185, swimming-pool:0.6812564760974815, helicopter:0.505161629511863
# COCO style result:
#
# AP50: 0.7041049544393588
# AP75: 0.3998428201588986
# mAP: 0.402004801212884