...
model = dict(
    type='RGFL',
    pretrained='/mnt/data1/pretrained_ckpt/pkinet_t_pretrain.pth',
    backbone=dict(
        type='PKINet',
        arch='T',
        drop_path_rate=0.1,
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/data/Aerial/checkpoints/pkinet/gfl_tiny_new'
#mAP: 0.6977889232635245
# ap of each class: plane:0.889245845774513, baseball-diamond:0.7381332543755927, bridge:0.487030928176538, ground-track-field:0.6412623226242459, small-vehicle:0.7774079996044344, large-vehicle:0.757223658497509, ship:0.8455267101060349, tennis-court:0.9089545113551116, basketball-court:0.7645030024818893, storage-tank:0.8245718963406029, soccer-ball-field:0.47329541711755047, roundabout:0.6127331687845003, harbor:0.6246578211433741, swimming-pool:0.7177929826349756, helicopter:0.40449432993599427
# COCO style result:

# AP50: 0.6977889232635245
# AP75: 0.40323323914494674
# mAP: 0.3991219983200034