...
model = dict(
    type='RGFL',
    pretrained='https://github.com/mmaaz60/EdgeNeXt/releases/download/v1.2/edgenext_base.pth',
    backbone=dict(
        type='EdgeNeXt',
        depths=[3, 3, 9, 3],
        dims=[80, 160, 288, 584],
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/edgenext/base'
