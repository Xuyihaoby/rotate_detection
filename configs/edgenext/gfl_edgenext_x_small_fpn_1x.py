...
model = dict(
    type='RGFL',
    pretrained='https://github.com/mmaaz60/EdgeNeXt/releases/download/v1.0/edgenext_small.pth',
    backbone=dict(
        type='EdgeNeXt',
        depths=[3, 3, 9, 3],
        dims=[32, 64, 100, 192],
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/edgenext/x_small'
