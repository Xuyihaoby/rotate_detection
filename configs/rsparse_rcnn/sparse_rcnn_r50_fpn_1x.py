        ...
        bbox_head=[
            dict(
                ...
                bbox_coder=dict(
                    ...
                    target_stds=[0.5, 0.5, 1.0, 1.0, 1.0],
                    angle_range=angle_version)) for _ in range(num_stages)
        ]),
...
# optimizer
optimizer = dict(type='AdamW', lr=0.000025/2, weight_decay=0.0001)
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/rsparse_rcnn_modified'

# 24e bs4
# mAP: 0.6059358444231846
# ap of each class: plane:0.8052741776985183, baseball-diamond:0.5707941128936205, bridge:0.37273535540763697, ground-track-field:0.5290090194947206, small-vehicle:0.6914963806487959, large-vehicle:0.7107015877993841, ship:0.7738704787756722, tennis-court:0.8739084140009284, basketball-court:0.6147950594102447, storage-tank:0.7468309062237162, soccer-ball-field:0.4047018164425095, roundabout:0.5331625020493009, harbor:0.49910740191345154, swimming-pool:0.538020344547304, helicopter:0.42463010904196596
# COCO style result:
#
# AP50: 0.6059358444231846
# AP75: 0.35741186465352676
# mAP: 0.3491405231604246
