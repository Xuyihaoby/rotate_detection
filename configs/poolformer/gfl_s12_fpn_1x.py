...
model = dict(
    type='RGFL',
    pretrained='https://github.com/sail-sg/poolformer/releases/download/v1.0/poolformer_s12.pth.tar',
    backbone=dict(
        type='PoolFormer',
        layers=[2, 2, 6, 2],
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/poolformer/vanilla'
# mAP: 0.720328449032019
# ap of each class: plane:0.8900386258388269, baseball-diamond:0.7420903602585506, bridge:0.4821036650391074, ground-track-field:0.631148785776534, small-vehicle:0.7740446012016591, large-vehicle:0.7958052581616368, ship:0.8707588259297373, tennis-court:0.9084771192798201, basketball-court:0.7993628622413815, storage-tank:0.812863457633633, soccer-ball-field:0.5348620153571426, roundabout:0.582530681811396, harbor:0.6621778852215867, swimming-pool:0.7099499998637532, helicopter:0.6087125918655197
# COCO style result:
#
# AP50: 0.720328449032019
# AP75: 0.4350684886868409
# mAP: 0.42144103982288367