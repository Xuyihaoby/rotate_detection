...
log_level = 'INFO'
load_from = None
resume_from = '/data1/xyh/checkpoints/uncertain/Sep/epoch_10.pth'
workflow = [('train', 1)]
work_dir = '/data1/xyh/checkpoints/uncertain/Sep'

# mAP: 0.6800781114347216
# ap of each class: plane:0.8882612392681748, baseball-diamond:0.7528325310345735, bridge:0.40037809465003393,
# ground-track-field:0.6777103233035604, small-vehicle:0.7491671664142465, large-vehicle:0.6613775588656268,
# ship:0.8187428416442226, tennis-court:0.9085859227008305, basketball-court:0.7871665980654421,
# storage-tank:0.7421400256826935, soccer-ball-field:0.5771998694831697, roundabout:0.6255398130447555,
# harbor:0.5548346667731799, swimming-pool:0.6565121353008354, helicopter:0.40072288528948147
# COCO style result:
# AP50: 0.6800781114347216
# AP75: 0.3938185370645924
# mAP: 0.39404406195554237
