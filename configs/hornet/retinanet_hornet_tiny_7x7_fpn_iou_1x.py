model = dict(
    type='RRetinaNet',
    pretrained='./checkpoints/hornet_tiny_7x7.pth',
    backbone=dict(
        type='HorNet',
        depths=[2, 3, 18, 2],
        base_dim=64,
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/hornet/rotate_iou'

# mAP: 0.7040223369796745
# ap of each class: plane:0.8929361874326619, baseball-diamond:0.7477221178969947, bridge:0.39995618163024377,
# ground-track-field:0.6922337624623852, small-vehicle:0.781121111256691, large-vehicle:0.6548909696809768,
# ship:0.8436158303728619, tennis-court:0.9081912947132823, basketball-court:0.8068689186557948,
# storage-tank:0.8023534730661955, soccer-ball-field:0.5985411113334906, roundabout:0.6494080300695565,
# harbor:0.5718002607795513, swimming-pool:0.6747607888167902, helicopter:0.5359350165276416
# COCO style result:
# AP50: 0.7040223369796745
# AP75: 0.4091666705470512
# mAP: 0.4073568979505876
