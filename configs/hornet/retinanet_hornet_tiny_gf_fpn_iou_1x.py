model = dict(
    type='RRetinaNet',
    pretrained='./checkpoints/hornet_tiny_gf.pth',
    backbone=dict(
        type='HorNet',
        depths=[2, 3, 18, 2],
        base_dim=64,
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data1/xyh/checkpoints/hornet/rotate_iou_gf'
# mAP: 0.7002472330537783
# ap of each class: plane:0.8931362894461936, baseball-diamond:0.7357304555787438, bridge:0.4090411027020368, ground-track-field:0.7064931611547968, small-vehicle:0.7806933449744234, large-vehicle:0.655796603737089, ship:0.8375297039548575, tennis-court:0.9081296006712691, basketball-court:0.8038711826687914, storage-tank:0.8061964161657965, soccer-ball-field:0.5638550094381927, roundabout:0.6286416551929765, harbor:0.5197517171687988, swimming-pool:0.6692147205613512, helicopter:0.5856275323913589
# COCO style result:
#
# AP50: 0.7002472330537783
# AP75: 0.3924342673996018
# mAP: 0.4002672797814343