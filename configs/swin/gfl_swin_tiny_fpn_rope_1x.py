...
model = dict(
    type='RGFL',
    pretrained='/mnt/data1/pretrained_ckpt/swin_rope_mixed_tiny_patch4_window7_224.pth',
    backbone=dict(
        type='RoPESwinTransformer',
        embed_dim=96,
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
        window_size=7,
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/data1/Aerial/checkpoints/swin_rope/gfl_tiny_new'

# mAP: 0.7358953914730301
# ap of each class: plane:0.886591406706011, baseball-diamond:0.7103335212715495, bridge:0.5146048950030359, ground-track-field:0.6992008796992419, small-vehicle:0.8004702777395917, large-vehicle:0.8307239804098026, ship:0.874781057179711, tennis-court:0.9089553250627078, basketball-court:0.8264823508580185, storage-tank:0.8502149458523376, soccer-ball-field:0.5230824694578705, roundabout:0.6360782269281532, harbor:0.70718363492322, swimming-pool:0.7336351749757029, helicopter:0.5360927260284962
# COCO style result:

# AP50: 0.7358953914730301
# AP75: 0.4500754402238956
# mAP: 0.43731804584444917
# The submitted information is :

# Description: /mnt/data1/Aerial/checkpoints/swin_rope/gfl_tiny_new