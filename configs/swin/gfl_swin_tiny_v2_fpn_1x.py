...
model = dict(
    type='RGFL',
    pretrained='https://github.com/SwinTransformer/storage/releases/download/v2.0.0/swinv2_tiny_patch4_window8_256.pth',
    backbone=dict(
...
data_root = '/mnt/data/DOTA1_0/simple/'
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/data/Aerial/checkpoints/swinv2/gfl_tiny_new'

# mAP: 0.7300521335694378
# ap of each class: plane:0.8887841010202844, baseball-diamond:0.7168825887827911, bridge:0.529387043241735,
# ground-track-field:0.6963645247636563, small-vehicle:0.7924957045799185, large-vehicle:0.816499585293349,
# ship:0.8724419279677534, tennis-court:0.9090240641711231, basketball-court:0.8232999163711894,
# storage-tank:0.8443842519671018, soccer-ball-field:0.5345254948477145, roundabout:0.6172923630936409,
# harbor:0.6684513688274025, swimming-pool:0.7224157406101259, helicopter:0.51853332800378
# COCO style result:
# AP50: 0.7300521335694378
# AP75: 0.4349720948425539
# mAP: 0.4305813133282069
