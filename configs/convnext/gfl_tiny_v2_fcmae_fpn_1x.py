...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/convnextv2_tiny_1k_224_fcmae.pt',
    backbone=dict(
        type='ConvNeXtV2',
        depths=[3, 3, 9, 3],
        dims=[96, 192, 384, 768],
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/convnextv2/fcmae_in1k'

# mAP: 0.6722397189943013
# ap of each class: plane:0.8854789252278261, baseball-diamond:0.6657140046650539, bridge:0.4924186614612105, ground-track-field:0.5806209714839683, small-vehicle:0.798356392904912, large-vehicle:0.7929028877546899, ship:0.862023574635437, tennis-court:0.9084780388151177, basketball-court:0.6776710719340013, storage-tank:0.7977234051957083, soccer-ball-field:0.3186527252875704, roundabout:0.5797511500885585, harbor:0.6625035088979676, swimming-pool:0.6747310851655502, helicopter:0.3865693813969461
# COCO style result:
#
# AP50: 0.6722397189943013
# AP75: 0.40414361103273405
# mAP: 0.39260943910813506