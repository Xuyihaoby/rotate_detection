...
model = dict(
    type='RGFL',
    pretrained='/home/xyh/rotate_detection/checkpoints/convnext_tiny_1k_224.pth',
    backbone=dict(
        type='ConvNeXt',
        in_chans=3,
        depths=[3, 3, 9, 3],
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/Aerial/checkpoints/convnext/vanilla'
# mAP: 0.7502662175044957
# ap of each class: plane:0.8879185774890492, baseball-diamond:0.7793920641442501, bridge:0.5455750766535947,
# ground-track-field:0.7029509285120845, small-vehicle:0.7945008769393573, large-vehicle:0.8134830630369954,
# ship:0.8761092940675599, tennis-court:0.9090245036190984, basketball-court:0.8577614369404646,
# storage-tank:0.8388083609383992, soccer-ball-field:0.6095357983424259, roundabout:0.6262757659501057,
# harbor:0.7181044595693996, swimming-pool:0.7150589664066536, helicopter:0.5794940899579968
# COCO style result:
# AP50: 0.7502662175044957
# AP75: 0.4657497755496184
# mAP: 0.4503855311304332