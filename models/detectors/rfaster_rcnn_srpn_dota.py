...
class RFasterRCNNSRPN(BaseDetector):
    ...
    def __init__(self,
                 ...
                 obb=False,
                 submission=False):
        super(RFasterRCNNSRPN, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(RFasterRCNNSRPN, self).init_weights(pretrained)
    ...
    def forward_train(self,
                      ...
                      **kwargs):
        """
         在原来的基础上增加了hor_gt_bboxes[_ignore]
        Args:
        ...
        if self.with_rpn:
            proposal_cfg = self.train_cfg.get('rpn_proposal',
                                              self.test_cfg.rpn)
            rpn_losses, proposal_list, mask_lvls = self.rpn_head.forward_train(
                x,
                img_metas,
                hor_gt_bboxes,
                gt_labels=None,
