...
from mmcv.runner import (HOOKS, DistSamplerSeedHook, EpochBasedRunner,
                         Fp16OptimizerHook, OptimizerHook, build_optimizer, build_runner)
...
def train_detector(model,
    ...
    # update by xyh
    # https://github.com/hyz-xmaster/swa_object_detection/blob/master/mmdet/apis/train.py
    ...
    if cfg.swa_resume_from:
        ...
        if cfg.swa_load_from == 'epoch_12.pth':
