...
class RConvFCBBoxHead(BBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(RConvFCBBoxHead, self).__init__(*args, **kwargs)
...
class RShared2FCBBoxHead(RConvFCBBoxHead):
    ...
    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class RShared4Conv1FCBBoxHead(RConvFCBBoxHead):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RShared4Conv1FCBBoxHead, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Oriented2BBoxHead(RConvFCBBoxHead):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Oriented2BBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
