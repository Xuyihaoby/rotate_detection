...
class RRetinaHeadOneR(AnchorHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 stacked_convs=4,
        ...
        super(RRetinaHeadOneR, self).__init__(
            num_classes,
            in_channels,
    ...
    def _init_layers(self):
        ...
        # add implicit
        self.ia = ImplicitA(self.feat_channels)
        self.im_reg = ImplicitM(self.num_anchors * 5)
        self.im_cls = ImplicitM(self.num_anchors * self.cls_out_channels,)
    ...
    def forward_single(self, x):
        ...
        cls_score = self.im_cls(cls_feat)
        bbox_pred = self.im_reg(reg_feat)
