...
from mmdet.core import (PointGenerator, build_assigner, build_sampler,
                        images_to_levels, multi_apply, multiclass_nms, multiclass_nms_r, unmap, obb2poly, poly2obb)
from ..builder import HEADS, build_loss
from .anchor_free_head import AnchorFreeHead

from mmdet.core.bbox.utils.gmm import GaussianMixture
from mmdet.core.bbox.rtransforms import gaussian2bbox
# from mmdet.utils.heatmap import showHeatmap


@HEADS.register_module()
class GRepHead(AnchorFreeHead):
    """RepPoint head.
    ...
    def _point_target_single(self,
        ...
        if stage == 'init':
            ...
            assign_result = assigner.assign(proposals, num_level_proposals, gt_bboxes, gt_bboxes_ignore,
                                            None if self.sampling else gt_labels)
    ...
    def get_targets(self,
        ...
        (all_labels, all_label_weights, all_bbox_gt, all_proposals,
         all_proposal_weights, pos_inds_list, neg_inds_list) = multi_apply(
            ...
            gt_labels_list,
            num_level_proposals=num_level_proposals,
            stage=stage,
    ...
    def _get_bboxes_single(self,
        ...
        for i_lvl, (cls_score, bbox_pred, bbox_pred_init, points) in enumerate(
            ...
            pts_pred_init = torch.cat([pts_pred_offsetx_init, pts_pred_offsety_init], dim=2).reshape(-1, 2 * self.num_points)

            if show_point:
                pts = pts_pred * self.point_strides[i_lvl]
            ...
            # 先聚合再加坐标
            # gmm.fit(pts_pred.reshape(-1, 9, 2))
            # bbox_pred = gaussian2bbox(gmm)
            ...
            pts_pred = pts_pred * self.point_strides[i_lvl] + bbox_pos_center
            gmm.fit(pts_pred.reshape(-1, 9, 2))
            bboxes = gaussian2bbox(gmm)
        ...
        if with_nms:
            ...
            det_bboxes, det_labels, keep = multiclass_nms_r(mlvl_bboxes, mlvl_scores,
                                                      ...
                                                      cfg.max_per_img, return_inds=return_inds, class_agnostic=True)
            if show_point:
