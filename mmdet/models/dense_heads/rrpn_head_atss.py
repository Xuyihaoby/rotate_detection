...
class RRPNHeadATSS(RPNTestMixin, AnchorHead):
    """RPN head.
    ...
    def __init__(self, in_channels, **kwargs):
        super(RRPNHeadATSS, self).__init__(1, in_channels, **kwargs)
    ...
    def loss(self,
        ...
        losses = super(RRPNHeadATSS, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def _get_targets_single(self,
        ...
        num_level_anchors_inside = self.get_num_level_anchors_inside(
            num_level_anchors_list, inside_flags)
