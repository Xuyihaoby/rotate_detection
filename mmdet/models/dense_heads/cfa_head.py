...
class CFAHead(AnchorFreeHead):
    ...
    def loss(self,
        ...
        with torch.no_grad():
            pos_losses_list, = multi_apply(self.get_pos_loss, cls_scores_image, pts_coordinate_preds_init_image,
            ...
            labels_list, label_weights_list, bbox_weights_list_refine, num_pos, pos_normalize_term = \
                multi_apply(self.reassign, pos_losses_list, labels_list_image, label_weights_list_image,
    ...
    def reassign(self, pos_losses, label, label_weight, pts_pred_init, pts_pred_refine, bbox_weight, gt_bbox, pos_inds,
                 pos_gt_inds,
        ...
        # label_weight[reweight_ids] = reassign_weights_after_cfa
        # bbox_weight[reweight_ids] = reassign_weights_after_cfa
