# modified from https://github.com/raoyongming/HorNet
# ------------------------------------------------
...
class GlobalLocalFilter(nn.Module):
    ...
    def forward(self, x):
        ...
        B, C, a, b = x2.shape
        # downgrade
        x2 = torch.rfft(x2, 2, normalized=True, onesided=True)
        ...
        # add: modified some dimension
        x2 = x2 * weight.contiguous()
        x2 = torch.irfft(x2, 2, normalized=True, onesided=True, signal_sizes=[a, b])
