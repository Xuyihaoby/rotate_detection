import numpy as np
import torch
from mmdet.ops import pointsJfAlign, pointsJf
import cv2
...
polygons = np.array([[200.,200.,400.,400.,500.,200.,400.,100.],
                     ...
                     [200.,200.,400.,400.,500.,200.,400.,100.],
                     [200.,200.,400.,400.,500.,200.,400.,100.],])
...
output = torch.full((polygons.shape[0], 1), 0.).cuda().float()
pointsJfAlign(points,polygons,output)
print(output)
pass